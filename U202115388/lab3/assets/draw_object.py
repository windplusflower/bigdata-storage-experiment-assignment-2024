...
# 文件名列表
file_names = ['objectSize512.txt', 'objectSize1024.txt',
              'objectSize2048.txt', 'objectSize4096.txt', 'objectSize8192.txt']
...
# 提取objectSize
object_sizes = [item['objectSize'] for item in all_data_parsed]
...
for parameter in parameters:
    ...
    for operation in operations:
        ...
        # 在图表上绘制参数
        plt.plot(object_sizes, parameter_data,
                 label=f'{operation} {parameter}')

    plt.title(f'Object Size vs {parameter}')
